...
Sai lầm gốc: **`OWNER` bị đặt làm vai trò NỀN TẢNG.** Nhưng "chủ sân" vốn dĩ gắn với _một sân
cụ thể_. Một người sở hữu sân A và làm nhân viên sân B là chuyện bình thường — mô hình hiện tại
không diễn đạt nổi.
...
**"Chủ sân" không còn là vai trò nền tảng.** Nó là _một dòng trong `VenueMember`_. Hệ quả:
